...
include('config.php');
$id=$_GET['id'];
$ret1=mysqli_query($con,"select * from places where id='$id' ");
...
$ret2=mysqli_query($con,"select * from city where id='$cit'");
...
<?php include('header.php'); ?>
          ...
          <section class="awe-parallax page-heading-demo text-center" style="background-image: url(image/places/<?php echo $img; ?>);" >
            ...
            <div class="container">
                <div class="row mt-34">
                        ...
                        <div class="col-md-12 text-center">
                                                        <h4 class="dest-heading71">Other Cities in <?php echo $citn; ?></h4>
<?php
$ret11=mysqli_query($con,"select * from places where cityid='$cit' and id<>'$id' ");
$row11=mysqli_fetch_array($ret11); 
{
?> 

                                                        <span style="margin-top:10px; margin-bottom:10px; "><a href="place.php?id=<?php echo $row11['id']; ?>" style="display:inline-block;border:2px solid #ED3237; font-size:16px; color:#000; border-radius:20px; padding:4px 10px; margin-right:10px; margin-top:3px; margin-bottom:3px;"><?php echo $row11['name']; ?></a></span>
                                                    <?php } ?>
                        ...
                        <div class="filter-page__content">
                            ...
                            <div class="filter-item-wrapper destination-list__content">
                                <?php
$ret=mysqli_query($con,"select * from packages where placesid='".$_GET['id']."' group by name ");
$ret1=mysqli_query($con,"select * from helicopter where placesid='".$_GET['id']."' group by name ");
                        ...
                        <div class="col-md-3">
                            <div class="item-price-more">
                                    ...
                                    <div class="col-md-12 col-xs-6 p-0 bnfg">
                                        <a href="awe-btn.php?id=<?php echo $row['id'] ?>" class="awe-btn">View Detail</a>
                                    </div>
...
<?php
$ret=mysqli_query($con,"select * from helicopter where placesid='".$_GET['id']."' group by name");
while ($row=mysqli_fetch_array($ret)) 
{
    $ida=$row['id'];
?> 
