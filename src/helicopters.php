               ...
               <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="product-title">
                            <?php
$ret=mysqli_query($con,"select * from helicopter where id='$id' ");
while ($row=mysqli_fetch_array($ret)) 
{
    $id1=$row['id'];
    $id2=$row['submenuwithheaderid'];
?> 
...
while ($row1=mysqli_fetch_array($ret1)) 
{
    ...
    ?>    
                                        ...
                                        <img src="image/helicopter/<?php echo $row1['image']; ?>" alt="<?php echo $row['name']; ?>  <?php echo $row['duration']; ?>">
...
<p style="margin-left:0cm; margin-right:0cm"><span style="font-size:11pt"><span style="font-family:Calibri,sans-serif"><strong><span style="font-size:12.0pt">Places covered-
<?php
...
while ($row1=mysqli_fetch_array($ret1)) 
{
    ...
    ?>     
| <?php echo $row1['name'] ?> | <?php } ?></span></strong></span></span></p>

<?php
$ret1=mysqli_query($con,"select * from helicopterabout where helicopterid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
...
<?php
$ret1=mysqli_query($con,"select * from helicopteritinerary where helicopterid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
                      ...
                      <div class="">
                        ...
                        <div class="row  p15 mb15 parentclass m-0 iternnary_border">
                          <span class="fs_12">
                              <ul>
                                <?php
$ret1=mysqli_query($con,"select * from helicopterinclusion where helicopterid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
    ...
    ?>    
                      ...
                      <div class=" ">
                        ...
                        <div class="row  p15 mb15 parentclass m-0 iternnary_border">
                          ...
                          <ul>
<?php
$ret1=mysqli_query($con,"select * from helicopterexclusion where helicopterid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
                          ...
                          <div class="ueac mt-5">
                               <h5><img src="https://img.icons8.com/windows/22/000000/sorting-options.png"/>&nbsp; Customize Tour</h5>
                                <p style="font-size: 12px;">Customizable itineraries where you may choose transport, stay & sightseeing as per your taste & comfort.</p>
                                                                                        ...
                                                                                        <p><span style="font-weight: 600;">Duration : &nbsp;<?php echo $row['duration']; ?></span></p>
            ...
            <div class="container">
                ...
                <div class=" ">
                    ...
                    <div class="row">
                        ...
                        <?php
$ret=mysqli_query($con,"select * from helicopter where  id<>'$id1'");
while ($row=mysqli_fetch_array($ret)) 
{
    $id4=$row['id'];
?> 
...
<?php
$ret1=mysqli_query($con,"select * from helicopterimages where helicopterid='$id4' limit 1 ");
while ($row1=mysqli_fetch_array($ret1)) 
{
?> 
                                    <img src="image/helicopter/<?php echo $row1['image'] ?>" alt="<?php echo $row['name'] ?>  <?php echo $row['duration'] ?>" class="boxi-img">
<?php } ?>
    ...
    font-weight: 600;"><i class="fa-solid fa-location-dot"></i> &nbsp;Location
                                          ...
                                          <a href="helicopters.php?id=<?php echo $row['id']; ?>" class="btnmn">Get Details</a> 
