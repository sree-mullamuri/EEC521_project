               ...
               <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="product-title">
                            <?php
$ret=mysqli_query($con,"select * from packages where id='$id' ");
...
<?php
$ret1=mysqli_query($con,"select * from packagesimage where packageid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
    ...
    ?>    
                                        ...
                                        <img src="image/packagesimage/<?php echo $row1['image']; ?>" alt="<?php echo $row['name']; ?>  <?php echo $row['duration']; ?>">
...
<?php
$ret1=mysqli_query($con,"select * from packageabout where packageid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
...
<?php
$ret1=mysqli_query($con,"select * from packageitinerary where packageid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
                      ...
                      <div class="">
                        ...
                        <div class="row  p15 mb15 parentclass m-0 iternnary_border">
                          <span class="fs_12">
                              <ul>
                                <?php
$ret1=mysqli_query($con,"select * from packageinclusion where packageid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
    ...
    ?>    
                      ...
                      <div class=" ">
                        ...
                        <div class="row  p15 mb15 parentclass m-0 iternnary_border">
                          ...
                          <ul>
<?php
$ret1=mysqli_query($con,"select * from packageexlusion where packageid='$id1' ");
while ($row1=mysqli_fetch_array($ret1)) 
{
            ...
            <div class="container">
                ...
                <div class=" ">
                    ...
                    <div class="row">
                        ...
                        <?php
$ret=mysqli_query($con,"select * from packages where submenuwithheaderid='$id2' and id<>'$id1'");
while ($row=mysqli_fetch_array($ret)) 
{
    $id4=$row['id'];
?> 
...
<?php
$ret1=mysqli_query($con,"select * from packagesimage where packageid='$id4' limit 1 ");
while ($row1=mysqli_fetch_array($ret1)) 
{
?> 
